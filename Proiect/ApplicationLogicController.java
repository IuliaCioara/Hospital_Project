...
public class ApplicationLogicController {
    ...
    private void addDatabaseConnectionConnectAsBiologActionListener() {
        graphicController.getDatabaseConnectionPanel().addConnectAsBiologButtonActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    private void addLogInPanelLogInButtonActionListener() {
        graphicController.getLogInPanel().addLogInButtonActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(connectedAsAdmin==false && connectedAsAsistenta==true) {
                ...
                else if(connectedAsAdmin==true && connectedAsAsistenta==false) {
                    ...
                    if(databaseLogicController.verifyLogInConditionsAsBiolog(id, password)) {
                        ...
                        JOptionPane.showMessageDialog(null,"Datele biologului sunt gresite", null, JOptionPane.PLAIN_MESSAGE);
                    }
                }
            }
        });
    ...
    private void displayAdminMainApplicationPanel() {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                graphicController.showAdminMainPanel();
                addMainAdminMainPanelModificareNumarPaturiActionListener();
                addMainAdminMainPanelModificaPretMedicamenteActionListener();
                addMainAdminMainPanelshowSectiiActionListener();
                addMainAdminMainPanelshowProduseActionListener();
    ...
    private void addMainAdminMainPanelLogOutActionListener() {
        graphicController.getAdminMainPanel().addLogOut(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    private void addMainAdminMainPanelModificareNumarPaturiActionListener() {
        graphicController.getAdminMainPanel().addModificaPaturiListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    private void addMainAdminMainPanelModificaPretMedicamenteActionListener() {
        graphicController.getAdminMainPanel().addModificaMedicamenteListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    private void addMainAdminMainPanelshowSectiiActionListener() {
        graphicController.getAdminMainPanel().addShowSecii(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                displaySectii();
            }
    ...
    private void addMainAdminMainPanelshowProduseActionListener() {
        graphicController.getAdminMainPanel().addShowProduse(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                displayProduse();
            }
    ...
    private void addBAButtonListener() {
        graphicController.getBuletinAnalize().addInsertBuletinActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(databaseLogicController.newBuletinAnalize(numeBiolog, Evaluarea_Calitatii, Rezultat, Observatii, Pret)) {
                    displayBiologMainApplicationPanel();
                }
                else {
    ...
    private void addIPPAddButtonActionListener () {
        graphicController.getInsertPacient().addInsertPacientActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    String result = databaseLogicController.insertNewPacient(CNP, nume, data_n, profesie, adresa, telefon, grup_sangvin, asigurat, sex, provenienta, categorie);
    ...
    private void addICPAddButtonListener() {
        graphicController.getInsertConsult().addInsertConsultActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (databaseLogicController.insertNewConsult(idSectie, medic, tipTrimitere, tipConsult, Diagnostic, Decizie)) {
    ...
    private void addMainAsistentaMainPaneladaugaRegistruActionListener() {
        graphicController.getAsistentaMainPanel().addAdaugaRegistruListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                diplayInsertRegistru();
            }
    ...
    private void addARAddButtonListener() {
        graphicController.getAdaugaRegistru().addAdaugaRegistruActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int parafa = Integer.parseInt(graphicController.getAdaugaRegistru().getParafaTextField().getText());
                if (databaseLogicController.insertNewRegistru(parafa)) {
                    if(decizie.equals("Se interneaza")) {
                        displayInsertInternare();
                    }
                    else {
    ...
    private void addAFPButtonListener() {
        graphicController.getAdaugaFisaPacient().addAdaugaFisaActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(databaseLogicController.insertNewFisaPacient(temp, tens, puls, evolutie)) {
                    displayMainApplicationPanel();
                }
                else {
                    JOptionPane.showMessageDialog(null, "Verify the input data", null, JOptionPane.ERROR_MESSAGE);
    ...
    private void addMainAsistentaMainPanelInsertTratamentActionListener() {
        graphicController.getAsistentaMainPanel().addInsertTratament(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    private void addITButtonListener() {
        graphicController.getInsertTratament().addInsertTratamentActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(databaseLogicController.insertNewTratament(DenumireMedicament, DenumireSanitar)) {
    ...
    private void addMainAsistentaMainPanelmodificaPacientActionListener() {
        graphicController.getAsistentaMainPanel().addModificaPacientListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    private void addMainAsistentaMainPanelistoricActionListener() {
        graphicController.getAsistentaMainPanel().addIstoricListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                displayInsertIstoric();
            }
    ...
    {
        String[] columnNames = {"id","Nume","CNP","Consultatii","Tratamente","Externari"};
        ResultSet resultSet = databaseLogicController.showIstoricInfo();
        String[][] data = parsematrixShowIstoric(resultSet, 0, 6);
        SwingUtilities.invokeLater(new Runnable() {
    ...
    public void addMainAsistentaMainPanelshowProduseActionListener() {
        graphicController.getAsistentaMainPanel().addShowProduse(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                displayProduse();
            }
    ...
    public void  addMainAsistentaMainPanelshowAnalizeActionListener()
    {

        graphicController.getAsistentaMainPanel().addShowAnalize(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                displayAnalize();
            }
    ...
    {
        String[] columnNames = {"id","NrReg","NrCrt","Parafa"};
        ResultSet resultSet = databaseLogicController.showRegistruInfo();
        String[][] data = parsematrixShowRegistru(resultSet, 0, 4);
        SwingUtilities.invokeLater(new Runnable() {
    ...
    {
        graphicController.getAsistentaMainPanel().addShowPacient(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                displayPacient();
            }
